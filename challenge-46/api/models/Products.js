...
module.exports = {
  attributes: {
    ...
    description: { type: "string", required: true, columnName: "description" },
    code: { type: "string", required: true, columnName: "code" },
    price: { type: "number", required: true, columnName: "price" },
    category: { type: "string", required: true, columnName: "category" },
    photo: { type: "string", required: true, columnName: "photo" },
